        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="w-full lg:w-8/12">
            ...
            {!searchQuery.trim() && activeCategory !== 'ALL' && (
              <div className="mb-12">
                <h2 className="text-xl font-bold mb-4 uppercase">Dry Climate Plants</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {!loading && !error && filteredProducts.slice(6, 10).map((product) => (
                    <div key={product.id} className="bg-white rounded-lg overflow-hidden">
                      <div className="relative">
                        <div className="bg-green-50 pt-4 px-4">
                          <div className="relative h-40 w-full">
          ...
          {/* Bundle summary */}
          <div className="w-full lg:w-4/12 h-fit sticky top-4">
